...
<CardGroup cols={2}>
  <Card title="Deploy on Railway" icon="train" href="https://railway.com/deploy/Ax4OH3?referralCode=rXZ78U">
    One-click deploy to Railway
  </Card>
  <Card title="Deploy to Google Cloud" icon="google" href="https://deploy.cloud.run/?git_repo=https://github.com/twangodev/ogis">
...
| Environment Variable | CLI Argument      | Default | Description                                                     |
|---------------------|-------------------|---------|------------------------------------------------------------------|
| `OGIS_HMAC_SECRET`  | `--hmac-secret`   | -       | Enable HMAC authentication (see [Authentication](/api-reference/authentication)) |
...
For private instances, see [Authentication](/api-reference/authentication).